...
.method public read(Ldc/squareup/okio/Buffer;J)J
    ...
    .line 1
    iget-boolean v2, p0, Ldc/squareup/okio/PeekSource;->closed:Z

    if-nez v2, :cond_5

    .line 5
    iget-object v2, p0, Ldc/squareup/okio/PeekSource;->expectedSegment:Ldc/squareup/okio/Segment;

    if-eqz v2, :cond_1

    iget-object v3, p0, Ldc/squareup/okio/PeekSource;->buffer:Ldc/squareup/okio/Buffer;

    iget-object v3, v3, Ldc/squareup/okio/Buffer;->head:Ldc/squareup/okio/Segment;

    if-ne v2, v3, :cond_0

    iget v2, p0, Ldc/squareup/okio/PeekSource;->expectedPos:I

    iget v3, v3, Ldc/squareup/okio/Segment;->pos:I

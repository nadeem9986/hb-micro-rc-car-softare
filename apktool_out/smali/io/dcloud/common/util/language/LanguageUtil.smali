...
.method public static getCurrentLocal(Landroid/content/Context;Z)Ljava/util/Locale;
    ...
    invoke-static {v0}, Landroidx/core/os/ConfigurationCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/res/Configuration;)Landroid/os/LocaleList;
    ...
    invoke-static {p1}, Landroidx/core/os/ConfigurationCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/res/Configuration;)Landroid/os/LocaleList;
    ...
    .line 6
    invoke-static {v0}, Landroidx/core/os/ConfigurationCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/os/LocaleList;)I
    ...
    .line 7
    invoke-static {v0, p0}, Landroidx/core/os/ConfigurationCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/os/LocaleList;I)Ljava/util/Locale;
...
.method public static getCurrentLocaleLanguage(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 8
    invoke-static {p0}, Landroidx/core/os/ConfigurationCompat$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/Locale;)Ljava/lang/String;
...
.method public static updateSystemLanguage(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Landroidx/core/os/ConfigurationCompat$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/String;)Ljava/util/Locale;
    ...
    .line 20
    invoke-static {v3}, Lio/dcloud/p/x1$$ExternalSyntheticApiModelOutline0;->m(Landroid/os/LocaleList;)V

    .line 21
    invoke-static {v2, v3}, Lio/dcloud/p/x1$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/res/Configuration;Landroid/os/LocaleList;)V
...
.method public static wrapContextConfigurationAfterO(Landroid/content/Context;Ljava/lang/String;Z)Landroid/content/Context;
    ...
    invoke-static {p1}, Landroidx/core/os/ConfigurationCompat$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/String;)Ljava/util/Locale;

...
.method public static addDynamicShortcuts(Landroid/content/Context;Ljava/util/List;)Z
    ...
    invoke-static {p0, v1}, Landroidx/core/app/DialogCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v1

    invoke-static {v1}, Landroidx/core/graphics/Insets$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;

    move-result-object v1

    invoke-static {v1, v0}, Landroidx/core/graphics/Insets$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/content/pm/ShortcutManager;Ljava/util/List;)Z
...
.method public static enableShortcuts(Landroid/content/Context;Ljava/util/List;)V
    ...
    invoke-static {v1, v0}, Landroidx/core/graphics/Insets$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;Ljava/util/List;)V
...
.method public static getDynamicShortcuts(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-static {v2}, Landroidx/core/app/Person$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/content/pm/ShortcutInfo;
...
.method public static pushDynamicShortcut(Landroid/content/Context;Landroidx/core/content/pm/ShortcutInfoCompat;)Z
    ...
    invoke-static {p0, v2}, Landroidx/core/app/DialogCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    .line 734
    invoke-static {v2, v3}, Landroidx/core/graphics/Insets$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;Landroid/content/pm/ShortcutInfo;)V
    ...
    .line 738
    invoke-static {v2}, Landroidx/core/graphics/Insets$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;)Z
    ...
    .line 741
    :cond_3
    invoke-static {v2}, Landroidx/core/graphics/Insets$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;)Ljava/util/List;
    ...
    invoke-static {v2, v3}, Landroidx/core/graphics/Insets$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/content/pm/ShortcutManager;Ljava/util/List;)V
    ...
    invoke-static {v2, v3}, Landroidx/core/graphics/Insets$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/content/pm/ShortcutManager;Ljava/util/List;)Z
...
.method public static setDynamicShortcuts(Landroid/content/Context;Ljava/util/List;)Z
    ...
    invoke-static {v1, v0}, Landroidx/core/graphics/Insets$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;Ljava/util/List;)Z
...
.method public static updateShortcuts(Landroid/content/Context;Ljava/util/List;)Z
    ...
    invoke-static {v1, v0}, Landroidx/core/graphics/Insets$$ExternalSyntheticApiModelOutline0;->m$2(Landroid/content/pm/ShortcutManager;Ljava/util/List;)Z
